...
const Resultado = () => {
    ...
    return (
        <div className="bg-gray-200 text-center mt-5 p-5 shadow">
            ...
            <p className="my-2">
                <span className="font-bold text-gray-800">Marca: </span> {nombreMarca.nombre}
            </p>
            <p className="my-2">
                <span className="font-bold text-gray-800">Año: </span> { yearRef.current}
            </p>
            <p className="my-2">
                <span className="font-bold text-gray-800">Plan: </span> {nombrePlan.nombre}
            </p>
